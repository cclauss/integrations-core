...
REPLICATOR_PRODUCER_METRICS = [
    ...
    'kafka.producer.producer_metrics.batch_split_rate',
    'kafka.producer.producer_metrics.batch_split_total',
    'kafka.producer.producer_metrics.buffer_available_bytes',
    'kafka.producer.producer_metrics.buffer_exhausted_rate',
    'kafka.producer.producer_metrics.buffer_exhausted_total',
    'kafka.producer.producer_metrics.buffer_total_bytes',
    'kafka.producer.producer_metrics.bufferpool_wait_ratio',
    'kafka.producer.producer_metrics.bufferpool_wait_time_total',
    'kafka.producer.producer_metrics.compression_rate_avg',
    ...
    'kafka.producer.producer_metrics.metadata_age',
    ...
    'kafka.producer.producer_metrics.record_error_total',
    'kafka.producer.producer_metrics.record_queue_time_avg',
    'kafka.producer.producer_metrics.record_queue_time_max',
    'kafka.producer.producer_metrics.record_retry_rate',
    'kafka.producer.producer_metrics.record_retry_total',
    'kafka.producer.producer_metrics.record_send_rate',
    'kafka.producer.producer_metrics.record_send_total',
    'kafka.producer.producer_metrics.record_size_avg',
    'kafka.producer.producer_metrics.record_size_max',
    'kafka.producer.producer_metrics.records_per_request_avg',
    'kafka.producer.producer_metrics.request_latency_avg',
    'kafka.producer.producer_metrics.request_latency_max',
    ...
    'kafka.producer.producer_metrics.requests_in_flight',
...
REPLICATOR_CONSUMER_METRICS = [
    'kafka.consumer.consumer_metrics.connection_close_rate',
    'kafka.consumer.consumer_metrics.connection_close_total',
    'kafka.consumer.consumer_metrics.connection_count',
    'kafka.consumer.consumer_metrics.connection_creation_rate',
    'kafka.consumer.consumer_metrics.connection_creation_total',
    'kafka.consumer.consumer_metrics.failed_authentication_rate',
    'kafka.consumer.consumer_metrics.failed_authentication_total',
    'kafka.consumer.consumer_metrics.failed_reauthentication_rate',
    'kafka.consumer.consumer_metrics.failed_reauthentication_total',
    'kafka.consumer.consumer_metrics.incoming_byte_rate',
    'kafka.consumer.consumer_metrics.incoming_byte_total',
    'kafka.consumer.consumer_metrics.io_ratio',
    'kafka.consumer.consumer_metrics.io_time_ns_avg',
    'kafka.consumer.consumer_metrics.io_wait_ratio',
    'kafka.consumer.consumer_metrics.io_wait_time_ns_avg',
    'kafka.consumer.consumer_metrics.io_waittime_total',
    'kafka.consumer.consumer_metrics.iotime_total',
    'kafka.consumer.consumer_metrics.last_poll_seconds_ago',
    'kafka.consumer.consumer_metrics.network_io_rate',
    'kafka.consumer.consumer_metrics.network_io_total',
    'kafka.consumer.consumer_metrics.outgoing_byte_rate',
    'kafka.consumer.consumer_metrics.outgoing_byte_total',
    'kafka.consumer.consumer_metrics.request_rate',
    'kafka.consumer.consumer_metrics.request_size_avg',
    'kafka.consumer.consumer_metrics.request_size_max',
    'kafka.consumer.consumer_metrics.request_total',
    'kafka.consumer.consumer_metrics.response_rate',
    'kafka.consumer.consumer_metrics.response_total',
    'kafka.consumer.consumer_metrics.select_rate',
    'kafka.consumer.consumer_metrics.select_total',
    'kafka.consumer.consumer_metrics.successful_authentication_no_reauth_total',
    'kafka.consumer.consumer_metrics.successful_authentication_rate',
    'kafka.consumer.consumer_metrics.successful_authentication_total',
    'kafka.consumer.consumer_metrics.successful_reauthentication_rate',
    'kafka.consumer.consumer_metrics.successful_reauthentication_total',
]
